...
const Navbar = () => {
  ...
  return  (
    ...
    <div className="flex-1">
      <Link to={'/'}>
      <img className='w-12 h-12 ml-7 ' src={"https://res.cloudinary.com/dlcnf8yfh/image/upload/v1719189950/organo_logo_opli1d.png"} alt="" />
      </Link>
      {/* <a className=" text-xl text-base-200 disabled"><Link to={'/'}></Link></a> */}
    </div>
