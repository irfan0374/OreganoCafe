                    ...
                    <div className='flex'>
                        <div className="mt-1 w-full relative">
                            <Link to={"/listPage"}>
                                <figure className='relative'>
                                    <LazyLoad height={200} offset={100}>
                                        <img className='h-48 w-full' src={oreganoSpecial} alt="shakes" />
                                    </LazyLoad>
            ...
            <div className='justify-center space-x-3'>
                ...
                <div className='grid grid-cols-3 gap-4 py-6'>
                    <Link to={"/juice"}>
                        <div>
                            <LazyLoad height={100} offset={100}>
                                <img src={"https://res.cloudinary.com/dlcnf8yfh/image/upload/v1719148511/shakes_mayaxw.png"} alt="" className="w-24 h-20 transform hover:scale-110 duration-200" />
                            </LazyLoad>
                    ...
                    <Link to={'/listPage/pizza'}>
                        <div>
                            <LazyLoad height={100} offset={100}>
                                <img src={"https://res.cloudinary.com/dlcnf8yfh/image/upload/v1719148508/pizza_ljitle.png"} alt="" className="w-20 h-20 transform hover:scale-110 duration-200" />
                            </LazyLoad>
                    ...
                    <Link to={'/listPage/pasta'}>
                        <div>
                            <LazyLoad height={100} offset={100}>
                                <img src={"https://res.cloudinary.com/dlcnf8yfh/image/upload/v1719133977/Firefly_20240623143328-removebg-preview_it3ria.png"} alt="" className="w-20 h-20 transform hover:scale-110 duration-200" />
                            </LazyLoad>
                    ...
                    <Link to={'/listPage/sandwich'}>
                        <div>
                            <LazyLoad height={100} offset={100}>
                                <img src={"https://res.cloudinary.com/dlcnf8yfh/image/upload/v1719148508/sandwitch_pvu1oe.png"} alt="" className="w-20 h-20 transform hover:scale-110 duration-200" />
                            </LazyLoad>
                            <h2 className="text-balance font-serif">Sandwich</h2>
                        </div>
                    </Link>
                    <Link to={'/listPage/wrap'}>
                        <div>
                            <LazyLoad height={100} offset={100}>
                                <img src={"https://res.cloudinary.com/dlcnf8yfh/image/upload/v1719148510/wrap_hdlsut.png"} alt="" className="w-20 h-20 transform hover:scale-110 duration-200" />
                            </LazyLoad>
